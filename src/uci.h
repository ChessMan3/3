...
#define OPT_TACTICAL_MODE   2
#define OPT_RAZORING        3
#define OPT_FUTILITY        4
#define OPT_PRUNING         5
#define OPT_NULLMOVE        6
#define OPT_PROBCUT         7
#define OPT_DEBUG_LOG_FILE  8
#define OPT_CONTEMPT        9
#define OPT_THREADS         10
#define OPT_HASH            11
#define OPT_CLEAR_HASH      12
#define OPT_PONDER          13
#define OPT_MULTI_PV        14
#define OPT_REP_FIX         15
#define OPT_SKILL_LEVEL     16
#define OPT_MOVE_OVERHEAD   17
#define OPT_MIN_THINK_TIME  18
#define OPT_SLOW_MOVER      19
#define OPT_NODES_TIME      20
#define OPT_CHESS960        21
#define OPT_SYZ_PATH        22
#define OPT_SYZ_PROBE_DEPTH 23
#define OPT_SYZ_50_MOVE     24
#define OPT_SYZ_PROBE_LIMIT 25
#define OPT_LARGE_PAGES     26
#define OPT_NUMA            27
